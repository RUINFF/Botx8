...
`
   ...
   case 'command':
               list = []
               listmenu = [`sewabot`,`groupmenu`,`photoxy`,`ephoto`,`randomimage`,`wibu2`,`storymenu`,`porno`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`ikyygroup`]
...
//------------------< Owner >-------------------
      ...
      case 'bc':
             ...
             for (let _ of anu100) {
             ikyy.sendMessage(_.jid, bc100, image, {quoted: freply, caption: `*「 DAVIZ GAMTENG 」*\n\n${body.slice(4)}`})
}
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              ikyy.sendMessage('6285855159230@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
